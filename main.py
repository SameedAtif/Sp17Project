...
def main(argv):
    ...
    c = core()
    c.system(video_path, "/media/4698AABF98AAAD3D/detection.avi", input_size=320, show=True, iou_threshold=0.1,rectangle_colors=(255,0,0),Track_only = ['car','truck','motorbike','person'], display_tm = tm, realTime = rt )
